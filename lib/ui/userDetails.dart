  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<UserState>(
      builder: (context,userState,_)=>Scaffold(
        appBar: new AppBar(
          title: new Text(userState.currentSelected.fullName(), style: TextStyle(color: Colors.white, 
              ...
              children: <Widget>[
                new Container(
                  ...
                  decoration: new BoxDecoration(
                    ...
                    image:
                        NetworkImage("images/icons/facebook_logo.png"),
                    fit: BoxFit.cover,
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: new Center(
                      child: new Hero(
                        tag: "images${userState.currentSelected.index}",
                        child: CircleAvatar(
                          radius: 100.0,
